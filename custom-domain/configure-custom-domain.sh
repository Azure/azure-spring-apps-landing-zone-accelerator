...
az keyvault set-policy -g ${RESOURCE_GROUP} -n ${VAULT_NAME} --object-id 938df8e2-2b9d-40b1-940c-c75c33494239 --certificate-permissions get list --secret-permissions get list
