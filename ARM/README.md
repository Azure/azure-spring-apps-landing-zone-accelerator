# ARM Template Quickstart - Azure Spring Apps Reference Architecture
...
* **3-8-21** - Added Network Security Groups to spoke app and runtime subnets. Added bring your own route table as documented in the [Azure Spring Apps documentation](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-tutorial-deploy-in-azure-virtual-network#bring-your-own-route-table).
