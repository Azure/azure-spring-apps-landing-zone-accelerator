...
#module.hub_spoke.hub_vnet_id          # azurerm_virtual_network.hub.id 
#module.hub_spoke.spoke_vnet_id        # azurerm_virtual_network.spoke.id
#azurerm_firewall.azure_firewall_instance.ip_configuration[0].private_ip_address
                                        # azurerm_route_table.default_apps_route.id
                                        # azurerm_route_table.default_runtime_route.id
