...
$SUBSCRIPTION='43fb1e17-a50d-49df-98c1-056e68b19779'
$RESOURCE_GROUP='sc-corp-rg'
$REGION='eastus'
$SPRING_CLOUD_SERVICE='spring-xai5crygg0eee'
$MYSQL_SERVER_NAME='mysql-xai5crygg0eee'
$MYSQL_SERVER_ADMIN_NAME='azureadmin' 
$MYSQL_SERVER_ADMIN_PASSWORD='P@ssw0rd12345'
