...
# === ARM ===
export RESOURCE_GROUP=resource-group-name # customize this - RG that contains Key Vault and Azure Spring Apps resources
...
export SPRING_CERT_NAME=app-domain-com # customize this - Name of certificate to Azure Spring Apps
...
export APP_NAME=spring-app-name # customize this - name of Azure Spring Apps app to add custom domain with SSL/TLS
export REGION=eastus # customize this
export SPRING_CLOUD_SERVICE=azure-spring-cloud-name # customize this - Name of Azure Spring Apps Service